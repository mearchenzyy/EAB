...
def process_EAB(batch, Lrange, cb_data, pauli_request_list, counts_batch=None, repeat=None, periodic=False, use_density_matrix = False, inject_pauli_sparse = None):
